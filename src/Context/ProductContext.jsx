...
import ProductDataC1 from "../Components/MainPages/ServicePage/ServiceProductSec/ServiceProductCategory1/ProductData";
...
const ProductDataAPI =
  "http://localhost:5050/api/item/get?categoryId=650437af7623e86332589260";
...
const AppProvider = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{ ...state, getProdDescription }}>
      {children}
    </AppContext.Provider>
  );
};
