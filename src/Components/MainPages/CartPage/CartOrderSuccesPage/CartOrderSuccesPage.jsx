...
import "./CartOrderSuccesPage.css"
import UserCartData from "../UserCartData"

export const CartOrderSuccesPage = () => {
  return (
    <div className='CPMain'>
        <div className='CP container'>
            <div className='CP-Head'>
            <div className='CPHead-Writeup'>
                <h2 className='CPHead-Heading' style={{color : "green"}}>Congratulations!...Your Order Placed Successfully</h2>
                <p className='CPHead-Content'>And You Are Done Now. Our Designers Will Contact You Soon</p>
            </div>
            <hr/>
            </div>
                ...
                <div className='CPBody-Head'>
                    ...
                    <div className='CPBodyHead-Content'>
                        <div className='CPBodyHeadContent-Head'>
                            <h2 className='CPBodyHeadContent-Heading'>{CartData.Heading}</h2>
                            <p className='CPBodyHeadContent-Body'>{CartData.Description}</p>
                        </div>
                        {/* <button className='CPBodyHead-AddMoreButton'>+ Add More</button> */}
                    </div>
                </div>
            ...
            <div className='CP-Base'>
                <div className='CPBase-Head'>
                    ...
                    <div className='CPBase-Value'>
                        ...
                        <h4 className='CPBaseValue-Amount'>₹500 - ₹1000</h4>

                    </div>
                    <hr/>
                </div>
                <div className='CPBase-Button'>
                <h6 className='CPBaseButton-Content'>*Our Designers Will Contact You Within 24hrs, to discuss further about your Projects*</h6>
                </div>
            </div>
...
export default CartOrderSuccesPage;