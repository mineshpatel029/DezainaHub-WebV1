    ...
    <div  className='FeaturedService-1'>
                        ...
                        <div className='PPBodyContent-Box'>
                            <div className='PPBodyContentBox-ImgContainer'>
                                <img className='PPBodyContentBox-Img' src={image} />
                            </div>
                            <div className='PPBodyContentBox-Content'>
                                <div className='PPBodyContentBox-HeadContent'>
                                    <h5 className='PPBodyContentBox-ProductName'>{name}</h5>
                                    <h6 className='PPBodyContentBox-ProductPrice'>{price}</h6>
                                </div>
                                
                                <p className='PPBodyContentBox-BodyContent'>i. {description}</p>
