  ...
  },
  {
    ...
    Description: {
        ...
        DescriptFooter: [
            ...
            { FooterPoints: 'For 5 or more slides - starting @ ₹400 per page after 5th page '},
            { FooterPoints: 'For 10 or more slides - starting @ ₹300 per page after 10th page'},
          ],
      },
    featured: true,
  },
  {
    ...
    Description: {
        ...
        DescriptFactors: [
          ...
          { factorsPoints: "Number of pages and complexity (single post or carousel post)" },
          { factorsPoints: "Revisions Included" },
        ],
