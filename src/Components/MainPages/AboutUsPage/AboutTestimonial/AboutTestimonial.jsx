    ...
    <div className='AboutTSMain'>
        <div className='AboutTS container'>
            <div className='AboutTS-Body'>
                ...
                <p className='AboutTSBody-Content'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.  and typesetting industry.  and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
