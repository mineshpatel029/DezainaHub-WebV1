  ...
  return (
    <div className="AboutLSMain">
      <div className="AboutLS container" data-aos="zoom-in-up">
        <h1 className="AboutLS-Head">
          No <span>More</span> Mediocre <span>Branding!</span>
        </h1>
        <div className="AboutLS-ImgBox">
          <div className="AboutLSImg-FloatBox">
            <div className="AboutLSImgFloatBox-Head">
              ...
              <svg
                className="AboutLSImgFloatBoxHead-Line"
                width="95"
                height="2"
                viewBox="0 0 95 2"
                fill="none"
            ...
            <div className="AboutLSImgFloatBox-Body">
              ...
              <p className="AboutLSImgFloatBoxBody-Content">
                From Companies into Memorable Brands: Your Journey to
                distinction!
              </p>
            </div>
          </div>
